...
function page_show($_var_15, $_var_16, $_var_17, $_var_18)
{
	...
	for ($_var_36 = $_var_23; $_var_36 <= $_var_24; $_var_36++) {
		if ($_var_36 == $_var_20) {
			$_var_32 = $_var_32 . '<li><a href="javascript:void(0)" class="page_current">' . $_var_36 . '</a></li>';
		} else {
			$_var_32 = $_var_32 . '<li><a href="' . $_var_25 . $_var_21 . '=' . $_var_36 . '" title="第' . $_var_36 . '页">' . $_var_36 . '</a>';
		}
	}
	...
	if ($_var_20 == $_var_19) {
		...
		$_var_34 = '<a href="' . $_var_25 . $_var_21 . '=' . ($_var_20 + 1) . '" title="下一页">>></a></li></li>';
	}
