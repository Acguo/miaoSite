...
<li><span class="text-muted">按剧情</span></li>
											  <li><a href="?m=/dongman/list.php?cat=all&page=1" >全部</a></li>
											  <?php
...
<li><a href="?m=/dongman/list.php?year=all&pageno=1">全部</a></li>
<?php
...
<li><a href="?m=/dongman/list.php?area=all&page=1">全部</a></li>
<?php
...
<?php
foreach($dmcat1 as $kcat=>$vcat){$flname=$dmname1[$kcat];
$flid='/dongman/list.php?year='.$flname.'&page=1';
