...
<dd><a href="./vlist.php?cid=0" class="acat" style="white-space: pre-wrap;">全部</a></dd>
<?php
$result = mysql_query('select * from mkcms_vod_class where c_pid=0 order by c_id asc');
while ($row = mysql_fetch_array($result)){

			echo '<dd><a href="./vlist.php?cid='.$row['c_id'].'" class="acat" style="white-space: pre-wrap;margin-bottom: 4px;">'.$row['c_name'].'</a></dd>';
		}
?>
<?php
if ($_GET['cid'] != 0){
