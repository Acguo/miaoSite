...
<![endif]-->
<link href="<?php echo $mkcms_domain;?>moban/<?php echo $mkcms_bdyun;?>/css/bootstrap.min.css" rel="stylesheet" type="text/css" />				
<link href="<?php echo $mkcms_domain;?>moban/<?php echo $mkcms_bdyun;?>/css/swiper.min.css" rel="stylesheet" type="text/css" >		
<link href="<?php echo $mkcms_domain;?>style/font/iconfont.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $mkcms_domain;?>moban/<?php echo $mkcms_bdyun;?>/css/blackcolor.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $mkcms_domain;?>moban/<?php echo $mkcms_bdyun;?>/css/style.min.css" rel="stylesheet" type="text/css" />
