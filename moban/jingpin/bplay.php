...
<div class="stui-player__video embed-responsive embed-responsive-16by9 clearfix">
					<div id="cms_player" style="height:0px; width:0px;display:none;wiidth:100%px;heiight:600px;"></div>
...
<h4 class="title">正在播放：<?php echo $d_name; ?><span class="js"></span></h4>
...
{	$d_scontent[$i]=explode('|',$d_scontent[$i]);
if($d_scontent[$i][1]!=""){
	echo'<li class="dyli"><a href="'.$mkcms_domain.'jx/jx.php?url='.$d_scontent[$i][1].'" target="ajax" id="'.$d_scontent[$i][0].'">'.$d_scontent[$i][0].'</a></li>';
}
	}
	}else{
		return '';
