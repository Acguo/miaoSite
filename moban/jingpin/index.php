...
<h3 class="title"><img src="<?php echo $mkcms_domain;?>moban/<?php echo $mkcms_bdyun;?>/img/icon_2.png"><a href="./tv.php?m=/dianshi/list.php?cat=all&page=1">电视剧</a></h3>
...
<li><a href="t./v.php?m=/dianshi/list.php?area=13&pageno=1" class="text-muted">欧美剧</a> <span class="split-line"></span></li>
</ul>
</div>
</div>
...
<h3 class="title"><img src="<?php echo $mkcms_domain;?>moban/<?php echo $mkcms_bdyun;?>/img/icon_12.png">同步热播</h3>
</div>
</div>
